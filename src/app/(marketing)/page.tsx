...
export default async function MarketingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-[#fafafa] flex flex-col selection:bg-red-600/30">
      ...
      <main className="flex-1">
        ...
        <section id="templates-showcase" className="py-20 bg-zinc-950/40 relative">
