  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        {/* Modern Pill Badge */}
        <div className="inline-flex items-center gap-2 rounded-full border border-red-500/20 bg-red-500/10 px-3.5 py-1 text-xs font-semibold text-red-400 mb-6 backdrop-blur-sm">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3.5 w-full sm:w-auto">
          <Link
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2.5 rounded-xl bg-red-600 px-7 py-3.5 text-sm sm:text-base font-bold text-white hover:bg-red-500 transition-all shadow-lg shadow-red-600/25 active:scale-95"
          >
          ...
          {!user && (
            <Link
              href="/login"
              className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-xl border border-zinc-800 bg-zinc-900/80 px-6 py-3.5 text-sm sm:text-base font-semibold text-zinc-300 hover:text-white hover:bg-zinc-800 transition-colors"
            >
              <span>Sign In</span>
            </Link>
          )}
