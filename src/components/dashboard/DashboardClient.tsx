  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border border-border bg-card p-5">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-2xl font-bold text-foreground">{resumes.length}</span>
        ...
        <div className="rounded-xl border border-border bg-card p-5">
          ...
          <div className="mt-2 text-2xl font-bold text-foreground">{totalViews}</div>
        ...
        <div className="rounded-xl border border-border bg-card p-5">
          ...
          <div className="mt-2 flex items-center gap-2">
            ...
            {usage.isPro ? (
              ...
              <span className="inline-flex rounded-full bg-muted px-2 py-0.5 text-[11px] font-medium text-muted-foreground border border-border">
                1 Resume Max
              </span>
            )}
          </div>
          <div className="mt-3 flex items-center justify-between text-xs">
            ...
            <Link
              href="/dashboard/billing"
              className="font-semibold text-foreground hover:text-accent-foreground underline"
            >
      ...
      {!usage.isPro && resumes.length >= 1 && (
        <div className="rounded-xl border border-border bg-gradient-to-r from-red-950/30 via-zinc-900 to-zinc-900 p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
          ...
          >
            <span>Upgrade to PRO ($1.00 / ₱62.78)</span>
      ...
      <div>
        ...
        {resumes.length === 0 ? (
          <div className="rounded-xl border border-dashed border-border bg-background p-12 text-center">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-card border border-border text-muted-foreground">
              <FileText className="h-6 w-6" />
            </div>
            <h3 className="mt-4 text-base font-semibold text-foreground">No resumes created yet</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {resumes.map((resume) => {
              ...
              return (
                <div
                  key={resume.id}
                  className="group relative rounded-xl border border-border bg-card hover:border-border transition-all p-5 flex flex-col justify-between"
                >
                  <div>
                    {/* Header Strip: Template & Publish Status */}
                    <div className="flex items-center justify-between gap-2 mb-3">
                      <span className="inline-flex items-center rounded-md bg-muted px-2 py-0.5 text-[11px] font-medium text-foreground capitalize border border-border">
                        {resume.template}
                      </span>
